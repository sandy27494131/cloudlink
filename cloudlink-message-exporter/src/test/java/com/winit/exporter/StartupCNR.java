 ...
 */
public class StartupCNR {

    public static final void main(String[] args) {
        Properties properties = new Properties();
        properties.setProperty("appId", "EXPORTER_CN.EXPORTER.ALL.CNR");
        properties.setProperty("appType", "EXPORTER");
        properties.setProperty("zone", "CNR");
        properties.setProperty("mq", "admin:admin123@172.16.3.207:5672/cn");
        ...
        Message<TestPayload> message = cloudlink.newMessageBuilder()
                .direct("EXPORTER_AU.EXPORTER.ALL.AUR", TestPayload.MESSAGE_TYPE, payload)
                .build();
        ...
        Command<TestPayload> command2US = cloudlink.newCommandBuilder()
                ...
                .toAppId("EXPORTER_AU.EXPORTER.ALL.AUR")
                .payload(payload)
                .build();
