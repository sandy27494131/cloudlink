...
/* Controllers */
angular.module('app').controller('exchangeListMonitorCtrl', ['$scope', '$translate', '$localStorage', 'HttpUtil', '$modal','$timeout','$interval','$stateParams','$rootScope',
    function($scope,$translate,$localStorage,HttpUtil,$modal,$timeout,$interval,$stateParams,$rootScope ) {
		...
		/*排序参数*/
		$scope.orderName='message_stats.publish_in_details.rate';
