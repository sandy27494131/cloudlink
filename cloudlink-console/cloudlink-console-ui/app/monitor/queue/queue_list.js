...
/* Controllers */
angular.module('app').controller('queueListMonitorCtrl', ['$scope', '$translate', '$localStorage', 'HttpUtil', '$modal','$timeout','$interval','$stateParams','$rootScope',
    function($scope,$translate,$localStorage,HttpUtil,$modal,$timeout,$interval,$stateParams,$rootScope ) {
		...
		/*排序参数*/
		$scope.orderName='messages_ready';
