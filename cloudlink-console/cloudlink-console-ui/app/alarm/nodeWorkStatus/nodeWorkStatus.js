...
/* Controllers */
angular.module('app').controller('nodeWorkStatusCtrl', ['$scope', '$translate', '$localStorage', 'HttpUtil', '$modal','$timeout',
    function($scope,$translate,$localStorage,HttpUtil,$modal,$timeout ) {
        ...
        $scope.initNodeWorkStatus=function(){
            HttpUtil.ajax({
                url : '/api/alarm/nodeWorkStatus',
                data : null,
                method : "GET",
                success : function(result) {
