...
public class Constants {
    ...
    // will clear all current routers
    public static final String ROUTER_TYPE_CLEAR = "clear";
    ...
    public static final String CLOUDLINK_PROPERTIES_KEY = "cloudlink.properties.file";

    public static final String DEFAULT_CLOUDLINK_PROPERTIES = "cloudlink.properties";

    public static final boolean DEFAULT_COMPRESSION_ENABLED = true;
    public static final Compress.CompressCodec DEFAULT_COMPRESSION_CODEC = Compress.CompressCodec.ZLIB;
    public static final int DEFAULT_COMPRESSION = Deflater.BEST_COMPRESSION;
    public static final int DEFAULT_NO_COMPRESSION_SIZE = 1024 * 100;//

    public static final boolean DEFAULT_MESSAGE_SIZE_LIMITED = true;
    public static final int DEFAULT_MESSAGE_WARN_BYTES = 1024 * 100;  //缺省消息载体大小警告阈值
    public static final int DEFAULT_MESSAGE_MAX_BYTES = 1024 * 1024;//缺省消息体载体载体大小最大阈值
