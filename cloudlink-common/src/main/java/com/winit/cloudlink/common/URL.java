 ...
 * <li>
 * registry://192.168.1.7:9090/com.alibaba.service1?param1=value1&amp;param2=
 * value2
 * </ul>
 * <p>
 ...
 * for this case, url protocol = null, url host = 192.168.1.3, port = 20880, url
 * path = null
 * <li>file:///home/user1/router.js?type=script<br>
 * for this case, url protocol = null, url host = null, url path =
 * home/user1/router.js
 * <li>file://home/user1/router.js?type=script<br>
 * for this case, url protocol = file, url host = home, url path =
 * user1/router.js
 * <li>file:///D:/1/router.js?type=script<br>
 * for this case, url protocol = file, url host = null, url path =
 * D:/1/router.js
 * <li>file:/D:/1/router.js?type=script<br>
 ...
 * home/user1/router.js
 * <li>home/user1/router.js?type=script <br>
 * for this case, url protocol = null, url host = home, url path =
 * user1/router.js
 * </ul>
 * 
...
public final class URL implements Serializable {
    ...
    /**
     * 获取IP地址. 请注意： 如果和Socket的地址对比， 或用地址作为Map的Key查找， 请使用IP而不是Host， 否则配置域名会有问题
     * 
     * @return ip
     */
    public String getIp() {
     ...
     * <code>getMethodParameter(String, String, int)</code>
    ...
    /**
     * @deprecated Replace to
     * <code>getMethodPositiveParameter(String, String, int)</code>
    ...
    /**
     * @deprecated Replace to
     * <code>getMethodParameter(String, String, boolean)</code>
